...
const App = () => {
  ...
  useEffect(() => {
    const tagFiltradas = fotos.filter(foto => {
      const filtroPorTag = !tag || foto.tagId === tag;
      return filtroPorTag
    })

    setFotosDeGaleria(tagFiltradas)
        ...
        <AppContainer>
          ...
          <MainContainer>
            ...
            <ContenidoGaleria>
              ...
              <Galeria alSeleccionarFoto={foto => setFotoSeleccionada(foto)} fotos={fotosDeGaleria} alAlternarFavorito={alAlternarFavorito} setTag={setTag} tag={tag}/>
            </ContenidoGaleria>
          </MainContainer>
        </AppContainer>
